...
def get_args():
    ...
    parser.add_argument('--eval_filters', type=str)
...
def main(args, ds_init):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        train_stats = train_one_epoch(
            ...
            bf16=args.bf16, loss_pos_weight=args.loss_pos_weight, do_lr_scale=args.do_lr_scale, cls_type=args.cls_type,
            class_names=args.class_names, predictions_per_frame=args.predictions_per_frame
        )
        ...
        if data_loader_val is not None:
            test_stats = validation_one_epoch(data_loader_val, model, device, ds=args.enable_deepspeed, bf16=args.bf16, loss_pos_weight=args.loss_pos_weight, run_name=args.job_name, 
                                              eval_filters=args.eval_filters, cls_type=args.cls_type, class_names=args.class_names, predictions_per_frame=args.predictions_per_frame)
